...
def register():
    ...
    if form.validate_on_submit():
        ...
        cursor.execute("INSERT INTO employee(employee_id, password, first_name, last_name, email_id, contact_no, basic_pay, department_id, date_of_joining, isadmin) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", (form.username.data, form.password.data, form.first_name.data, form.last_name.data, form.email.data, form.contact_no.data, form.basic_pay.data, form.department_id.data, 'now()', form.isadmin.data))
        ...
        "_id" : form.username.data, "first_name" : form.first_name.data, "last_name" : form.last_name.data, "email_id" : form.email.data, "basic_pay" : form.basic_pay.data,"contact_no" : form.contact_no.data,
