...
conn = psycopg2.connect(host = "127.0.0.1", user = "postgres", password= "harshtiw12@#", port ="5432", database = "faculty_portal")
cursor = conn.cursor()
...
def initialize():
    ...
    cursor.execute('''ALTER TABLE employee ALTER COLUMN password SET DEFAULT 'iitlucknow' ''');
